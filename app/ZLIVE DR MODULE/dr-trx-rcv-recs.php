			...
			<table class="metblentry-font table-striped table-hover table-bordered table-sm">
				...
				<tbody>
					...
					if($rlist !== ''):
						...
						if($row['claim_tag'] == 'Y'):
						if($row['claimdateCount'] > 13 && ($row['post_tag'] != 'Y' || $row['df_tag'] != 'F') AND ($row['supplier_id'] == '3' OR $row['supplier_id'] == '1425' OR $row['supplier_id'] == '4773' OR $row['supplier_id'] == '7805') && $row['encd_date'] >= '2021-11-02' ):
							$mydrtrx->UpdateStatusAboveseven($row['recid'],$row['trx_no'],'13D');
						endif;
						else:
							if($row['issevenDays'] > 7 && ($row['post_tag'] != 'Y' || $row['df_tag'] != 'F') AND ($row['supplier_id'] == '3' OR $row['supplier_id'] == '1425' OR $row['supplier_id'] == '4773' OR $row['supplier_id'] == '7805') && $row['encd_date'] >= '2021-11-02' ):
