        ...
        $str ="
            ...
            $str="
                ...
                (
                    ...
                    (SELECT COUNT(aa.`recid`) intransit_crpl FROM `trx_crpl` aa JOIN `mst_companyBranch` cc ON (aa.`brnch_rid` = cc.`recid`) WHERE aa.`is_receive` = 'N' {$str_date_crpl} {$optn_branch_crpl} {$str_branchgrparea}) nn,
